...
Setting.create(key: 'twitter_handle', value: '@transforma_CR')
Setting.create(key: 'twitter_hashtag', value: '#transforma_CR')
Setting.create(key: 'facebook_handle', value: 'TransformaCR')
Setting.create(key: 'youtube_handle', value: 'TransformaCR')
Setting.create(key: 'telegram_handle', value: 'TransformaCR')
Setting.create(key: 'instagram_handle', value: 'TransformaCR')
Setting.create(key: 'blog_url', value: '/blog')
Setting.create(key: 'url', value: 'http://localhost:3000')
Setting.create(key: 'org_name', value: 'Transformá CR')
...
Setting.create(key: 'comments_body_max_length', value: '1000')
Setting.create(key: 'mailer_from_name', value: 'Transformá CR')
Setting.create(key: 'mailer_from_address', value: 'noreply@transformacr.dev')
